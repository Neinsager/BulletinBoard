    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), "Base", null });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "Email", "Login", "Name", "PasswordHash", "PhoneNumber", "Role" },
                values: new object[] { new Guid("62d5d65f-7fd5-414c-8606-2045360f66c2"), "admin@admin.com", "Admin", "Admin", "562061253624346052140999182121123971381626070134955611791154493616316819712631", "+12345678901", "Admin" });
